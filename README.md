...
**기획서 + 공개 GitHub 레포 URL**을 입력하면 레포에서 README·코드를 수집해 3대 분야 점수표와 평가 후기를 출력합니다.
...
- **입력:** 기획서, GitHub 공개 레포 URL (README·코드 자동 수집)
...
├── app.py                      # Streamlit UI
├── judge/                      # 평가 로직
├── prompts/domain1_public.txt  # 분야별 심사 프롬프트
├── prompts/domain2_intent.txt
├── prompts/domain3_readme.txt
├── prompts/review_summary.txt
└── specs/
    ├── PLAN.md                 # 앱 기획서
